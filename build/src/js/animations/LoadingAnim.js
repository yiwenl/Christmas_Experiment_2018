...
//*/
const COLOR_PINK = "#a0a0a0";
/*/
const COLOR_PINK = "#f69882";
//*/

class LoadingAnim extends alfrid.EventDispatcher {
	constructor() {

		super();

		this.canvas = document.body.querySelector('.loading-anim');
	...
	startAnimation() {
	  ...
	  let animationList = [
	    {type: 'arc',start: 0,end: -360, sAngle: 0, radius: 398, x: 400,y: 400,delay: 0, duration: 1,color: COLOR_PINK, reverse: true},
	    {type: 'eye'},
